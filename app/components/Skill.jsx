...
const skills = [
  ...
  { name: "JWT", category: "Authentication", level: 90 },
  { name: "Firebase Auth", category: "Authentication", level: 90 },
];
...
const Skills = () => {
  ...
  return (
    <section id="skills" className=" bg-[#0f172a] text-white px-6 py-12 mt-8">
